...
void ShooterSubsystem::init() {
	//shooterWheel->SetStatusFrameRateMs(CANTalon::StatusFrameRateQuadEncoder, 10);
	//shooterWheel->SetStatusFrameRateMs(CANTalon::StatusFrameRateFeedback, 10);
	...
	if (ds->GetAlliance() == DriverStation::Alliance::kRed) {
		switch (shotSelection) {
			...
			case ShotSelection::removeBalls:
				...
				hoodPos = 0;
				break;
			case ShotSelection::launchPadLine:
				shooterVelocity = -3225;
				hoodPos = 0.212;
				break;
			case ShotSelection::paradeShot:
				shooterVelocity = -3375;
				hoodPos = 0.362;
				break;
			default:
				break;
		...
		switch (shotSelection) {
			case ShotSelection::hopper:
				...
				//shooterVelocity = -3025;
				//shooterVelocity = -3050;
				//shooterVelocity = -3020;
				//shooterVelocity = -2995;
				shooterVelocity = -3002;
				hoodPos = 0.05;
				break;
			case ShotSelection::loadingZone:
			...
			case ShotSelection::gearFar:
				...
				//shooterVelocity = -3600;
				//hoodPos = 0.198;
				shooterVelocity = -3525;
				hoodPos = 0.248;
				break;
			case ShotSelection::removeBalls:
				shooterVelocity = -750;
...
double ShooterSubsystem::getHoodSetpoint() {
	return hoodPos;
}
