...
void DashboardReporterSubsystem::setVisionEnabled(bool enabled) {
	_mutexVisionEnabled.lock();
	visionEnabled = enabled;
	_mutexVisionEnabled.unlock();
}

void DashboardReporterSubsystem::setJetsonOperational(bool operational) {
	_mutexJetsonOperational.lock();
	jetsonOperational = operational;
	_mutexJetsonOperational.unlock();
}

void DashboardReporterSubsystem::setOnTarget(bool onTarget) {
	_mutexOnTarget.lock();
	this->onTarget = onTarget;
	_mutexOnTarget.unlock();
}
