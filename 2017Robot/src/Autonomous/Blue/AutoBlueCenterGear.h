/*
 * AutoBlueCenterGear.h
 *
 *  Created on: Apr 22, 2017
 *      Author: roberthilton
 */

#ifndef SRC_AUTONOMOUS_BLUE_AUTOBLUECENTERGEAR_H_
#define SRC_AUTONOMOUS_BLUE_AUTOBLUECENTERGEAR_H_
...
class AutoBlueCenterGear: public CustomAction {
public:
	AutoBlueCenterGear(Controllers *robotControllers, vector<CustomSubsystem*> *subsystemVector)
...
#endif /* SRC_AUTONOMOUS_BLUE_AUTOBLUECENTERGEAR_H_ */
